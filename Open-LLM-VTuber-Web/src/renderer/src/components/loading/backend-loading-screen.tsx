    ...
    <>
      ...
      >
        ...
        <Box
          ...
          style={{ animation: 'loadingPulse 4s ease-in-out infinite' }}
        />
        <Box
          position="absolute"
          bottom="-15%"
          ...
          style={{ animation: 'loadingPulse 5s ease-in-out infinite 0.5s' }}
        />
        <Box
          position="absolute"
          top="30%"
          ...
          style={{ animation: 'loadingPulse 6s ease-in-out infinite 1s' }}
        />
        ...
        <VStack gap={8} position="relative" zIndex={1}>
          ...
          <Box position="relative" width="80px" height="80px">
            ...
            <Box
              ...
              style={{ animation: 'loadingSpin 1.5s linear infinite' }}
            />
            {/* Inner glow */}
            <Box
              position="absolute"
            ...
            <Box width="280px">
              ...
              >
                <Box
                  ...
                  style={{ 
                    animation: downloadProgress ? undefined : 'loadingProgress 3s ease-in-out infinite',
          ...
          <Box display="flex" gap={2}>
            {[0, 1, 2].map((i) => (
              <Box
                ...
                style={{ animation: `loadingDot 1.5s ease-in-out infinite ${i * 0.2}s` }}
              />
            ))}
          </Box>
        </VStack>
