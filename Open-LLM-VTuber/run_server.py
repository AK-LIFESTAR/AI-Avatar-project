...
def _get_base_dir() -> Path:
    ...
    - PyInstaller: folder containing the executable (so bundled ./models etc are found)
    """
...
def check_frontend_submodule(lang=None):
    ...
    # Packaged (PyInstaller) builds do not include git metadata/submodules and should not run git.
    if getattr(sys, "frozen", False):
        return
